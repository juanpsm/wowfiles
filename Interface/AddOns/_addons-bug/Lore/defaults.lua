...
-- Language: Draenei - courtesy of Blizzard
Lore_Archive[ALLIANCE_DRAENEI] = {
...
-- Language: Thalassian - courtesy of Blizzard
Lore_Archive[HORDE_ELF] = {
...
-- todo: refine/research ALLIANCE_DRAENEI and HORDE_ELF
