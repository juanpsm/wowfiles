...
function GMGenie.Macros.Discipline.Mute.run(name, title)
    if GMGenie_SavedVars.mute[title]["announceToServer"] then
        SendChatMessage('.name ' .. name .. ' fue muteado por ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' minuto(s). Motivo: ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
    else
        SendChatMessage('.gmname ' .. name .. ' fue muteado por ' .. GMGenie_SavedVars.mute[title]["duration"] .. ' minuto(s). Motivo: ' .. GMGenie_SavedVars.mute[title]["reason"], "GUILD");
    end
...
function GMGenie.Macros.Discipline.CharBan.run(name, title)
    if GMGenie_SavedVars.charBan[title]["announceToServer"] then
        SendChatMessage('.name El PJ: ' .. name .. ' fue baneado por ' .. GMGenie_SavedVars.charBan[title]["duration"] .. '. Motivo: ' .. GMGenie_SavedVars.charBan[title]["reason"], "GUILD");
    else
        SendChatMessage('.gmname El PJ: ' .. name .. ' fue baneado por ' .. GMGenie_SavedVars.charBan[title]["duration"] .. '. Motivo: ' .. GMGenie_SavedVars.charBan[title]["reason"], "GUILD");
    end
...
function GMGenie.Macros.Discipline.AccBan.run(name, title)
    if GMGenie_SavedVars.accBan[title]["announceToServer"] then
        SendChatMessage('.name La cuenta del PJ: ' .. name .. ' fue baneada por: ' .. GMGenie_SavedVars.accBan[title]["duration"] .. '. Motivo: ' .. GMGenie_SavedVars.accBan[title]["reason"], "GUILD");
    else
        SendChatMessage('.gmname La cuenta del PJ: ' .. name .. ' fue baneada por: ' .. GMGenie_SavedVars.accBan[title]["duration"] .. '. Motivo: ' .. GMGenie_SavedVars.accBan[title]["reason"], "GUILD");
    end
