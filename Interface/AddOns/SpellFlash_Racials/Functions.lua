...
Table.Castable["Stoneform"] = function()
	local z = {}
	z.SpellName = SpellName(20594--[[Stoneform]])
	return SpellFlashAddon.CheckIfSpellCastable(z)
end

Table.Castable["Berserking"] = function()
	local z = {}
...
Table.Castable["Will of the Forsaken"] = function()
	local z = {}
...
Table.Castable["Every Man for Himself"] = function()
	local z = {}
