...
-- Example function:
Table.VehicleCastable["English_Spell_Name"] = function()
	local z = {}
	...
	z.GlobalVehicleCooldownSpell = SpellName(GlobalSpellID--[[English_Spell_Name]])   -- use this if spell has more then a global cooldown
...
Table.VehicleCastable["Defend"] = function()
	local z = {}
...
Table.VehicleCastable["Shield-Breaker"] = function()
	local z = {}
...
Table.VehicleCastable["Charge"] = function()
	local z = {}
...
Table.VehicleCastable["Thrust"] = function()
	local z = {}
