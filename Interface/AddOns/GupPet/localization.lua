...
-------------------------------------------------------------------------------
	...
	GUPPET_S["USE"] = " or " ;
	GUPPET_S["SLOWGROUNDMOUNT"] = { "sgm" , "slowgroundmount"	, "Selects random a slow ground mount" } ;
	GUPPET_S["FASTGROUNDMOUNT"] = { "fgm" , "fastgroundmount"	, "Selects random a fast ground mount" } ;
	GUPPET_S["MULTIGROUNDMOUNT"] = { "mgm" , "multigroundmount"	, "Selects random a multi ground mount" } ;
	GUPPET_S["SLOWFLYMOUNT"] 	= { "sfm" , "slowflymount" 		, "Selects random a slow fly mount" } ;
	GUPPET_S["FASTFLYMOUNT"] 	= { "ffm" , "fastflymount" 		, "Selects random a fast fly mount" } ;
	...
	GUPPET_L["SLOWGROUNDMOUNT"]	= { "Slow" , "(60%)" };
	GUPPET_L["FASTGROUNDMOUNT"]	= { "Fast" , "(100%)" };
	GUPPET_L["MULTIGROUNDMOUNT"]= { "Multi" , "" };
	GUPPET_L["SLOWFLYMOUNT"]	= { "Slow" , "(150%)" };
	GUPPET_L["FASTFLYMOUNT"]	= { "Fast" , "(280% + 310%)" };
	GUPPET_L["COMPANION"]		= { "" , "" };
	...
	GUPPET_L["INGAMEBUTTONS_AUTO"]		= { "Auto Select" , " +Shift to force a ground type |n +Ctrl for a multi ground type" , " +Alt to use TravelFrom / GhostWolf" };
	...
	GUPPET_T["UNKNOWNSLASHCOMMAND"] = "|cffee4400 The slashcommand you entered is not correct. Check the optionmenu for the correct one. |r ( /GupPet om )";
